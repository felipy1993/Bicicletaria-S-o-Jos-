      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <p className="mt-4 text-gray-500 text-sm max-w-xs text-center md:text-left">
              Oficina especializada em manutenção de bicicletas. Qualidade e confiança em Guapiaçu.
            </p>
          </div>

          <div className="text-center md:text-right space-y-1">
            <p className="font-bold text-lg text-white uppercase tracking-wider">Bicicletaria São José</p>
            <p className="text-gray-400">R. das Orquídeas, 170 — Guapiaçu/SP</p>
